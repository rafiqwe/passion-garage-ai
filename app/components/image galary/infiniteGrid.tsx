...
export const InfiniteDraggableGrid: React.FC<InfiniteDraggableGridProps> = ({ gallery }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-10 flex items-center justify-center pointer-events-none">
        <h1 className="text-6xl font-bold tracking-wider text-white select-none opacity-80 drop-shadow-2xl font-sora">
          drag to see
        </h1>
      </div>
    </div>
...
export default function Infinitegrid() {
    ...
    return (
      <div className="w-full h-full bg-black flex items-center justify-center text-white font-sans min-h-[400px]">
        <div className="text-center">
          <div className="inline-block w-8 h-8 mb-2 border-b-2 border-white rounded-full animate-spin"></div>
  ...
  return (
    <div className="w-full h-full bg-black overflow-hidden m-0 min-h-[400px]">
      ...
      {isLoading && (
        <div className="absolute text-xs text-white opacity-50 top-2 right-2">
          Updating...
        </div>
      )}
    </div>
